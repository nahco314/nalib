...
def build():
    ...
    # with tarfile.open('xz.tar.xz', 'r:xz') as tar:
    #     tar.extractall(path='src/include')
    os.chdir("../")
    os.chdir("../")
    ...
    subprocess.run("g++ -shared -I ./src/include/ ./build/cppset.o -o ./cppset.pypy36-pp73-x86_64-linux-gnu.so".split(), check=True)
